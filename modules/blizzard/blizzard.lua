...
do
    ...
    local function variablesLoaded()
        ...
        if pendingChanges or not lastInfoFrame then
            ...
            if _G.NUM_LE_FRAME_TUTORIAL_ACCCOUNTS and type(_G.NUM_LE_FRAME_TUTORIAL_ACCCOUNTS) == 'number' then
