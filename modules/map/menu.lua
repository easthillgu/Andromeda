...
MAP.MenuList = {
    ...
    },
    {
        ...
        notCheckable = true,
        func = function()
            if ToggleLFGParentFrame then ToggleLFGParentFrame()
            elseif ToggleLFGFrame then ToggleLFGFrame()
            elseif LFGParentFrame then LFGParentFrame:Toggle()
            end
        end
    },

    {
        text = _G.COLLECTIONS,
        notCheckable = true,
        func = function() if ToggleCollectionsJournal then ToggleCollectionsJournal() end end
    },
    {
        text = _G.ACHIEVEMENT_BUTTON,
        notCheckable = true,
        func = function() if ToggleAchievementFrame then ToggleAchievementFrame() end end
    },
    {
        text = L['Calendar'],
        notCheckable = true,
    ...
    --]]
    {
        ...
        func = function()
            if not _G.GameMenuFrame:IsShown() then
                if _G.VideoOptionsFrame and _G.VideoOptionsFrame:IsShown() then
                    _G.VideoOptionsFrameCancel:Click()
                elseif _G.AudioOptionsFrame and _G.AudioOptionsFrame:IsShown() then
