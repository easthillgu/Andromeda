...
local function createBar()
    ...
    channelBar:SetPoint('TOPLEFT', _G.ChatFrame1, 'BOTTOMLEFT', 0, -2)
...
local function createLobbyButton()
    if GetCVar('portal') == 'CN' or GetCVar('portal') == 'KR' then
        ...
        if _G.ChatConfigChannelSettings_UpdateCheckboxes then
            hooksecurefunc('ChatConfigChannelSettings_UpdateCheckboxes', checkChannelStatus)
        end
