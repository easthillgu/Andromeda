...
function INVENTORY:OnLogin()
    ...
    function MyButton:OnUpdateButton(item)
        ...
        if atlas then
            ...
            if secondAtlas and self.IconOverlay2 then
    ...
    pcall(SetCVarBitfield, 'closedInfoFrames', _G.LE_FRAME_TUTORIAL_EQUIP_REAGENT_BAG, true)
    pcall(SetCVar, 'professionToolSlotsExampleShown', 1)
