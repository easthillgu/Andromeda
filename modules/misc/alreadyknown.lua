...
local function IsAlreadyKnown(link, index)
    ...
    elseif linkType == 'item' then
        ...
        if itemClassID == Enum.ItemClass.Battlepet and index then
            local data = C_TooltipInfo and C_TooltipInfo.GetGuildBankItem and C_TooltipInfo.GetGuildBankItem(GetCurrentGuildBankTab(), index)
            if data then
            ...
            local data = C_TooltipInfo and C_TooltipInfo.GetHyperlink and C_TooltipInfo.GetHyperlink(link, nil, nil, true)
            if data then
