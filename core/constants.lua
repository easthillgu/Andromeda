...
do
    ...
    C.QualityColors[Enum.ItemQuality.Standard] = C.QualityColors[Enum.ItemQuality.Standard] or { r = _G.BAG_ITEM_QUALITY_COLORS[1].r, g = _G.BAG_ITEM_QUALITY_COLORS[1].g, b = _G.BAG_ITEM_QUALITY_COLORS[1].b }
...
do
    ...
    local function CheckMyRole()
        local tree = GetSpecialization and GetSpecialization() or GetActiveSpecGroup and GetActiveSpecGroup()
        if not tree then
            return
        end
...
-- Fallback: defined fully in gui/configs.lua (may load later)
C.AccountSettings = C.AccountSettings or {}
C.CharacterSettings = C.CharacterSettings or {
    InstallationComplete = false,
    General = { PetFilter = false },
    Unitframe = { Enable = true, RaidFrame = true, Arena = true },
    Actionbar = { Enable = true, ButtonMargin = 4, BarPadding = 6 },
    Nameplate = { Enable = true },
}

-- Fallback: data tables defined in gui/configs.lua (may load later)
C.RaidDebuffsList = C.RaidDebuffsList or {}
C.RaidDebuffsBlackList = C.RaidDebuffsBlackList or {}
C.RaidBuffsWhiteList = C.RaidBuffsWhiteList or {}
C.CornerSpellsList = C.CornerSpellsList or {}
C.PartySpellsList = C.PartySpellsList or {}
C.MajorSpellsList = C.MajorSpellsList or {}
C.AnnounceableSpellsList = C.AnnounceableSpellsList or {}
C.CooldownPulseIgnoredSpellsList = C.CooldownPulseIgnoredSpellsList or {}
C.SpecialUnitsList = C.SpecialUnitsList or {}
C.PowerUnitsList = C.PowerUnitsList or {}
C.TrashUnitsList = C.TrashUnitsList or {}
C.TalentCDFixList = C.TalentCDFixList or {}
C.NameplateAuraWhiteList = C.NameplateAuraWhiteList or {}
C.NameplateAuraBlackList = C.NameplateAuraBlackList or {}
C.NameplateShowTargetNPCsList = C.NameplateShowTargetNPCsList or {}
C.BadBoys = C.BadBoys or {}
C.DevsList = C.DevsList or {}
C.ContactList = C.ContactList or {}
C.IgnoreNotesList = C.IgnoreNotesList or {}
C.HelpTips = C.HelpTips or {}
C.KeystoneInfo = C.KeystoneInfo or {}
C.CovenantLevels = C.CovenantLevels or {}
C.Frames = C.Frames or {}
C.ProfileNames = C.ProfileNames or {}
C.UIAnchor = C.UIAnchor or {}
C.UIAnchorTemp = C.UIAnchorTemp or {}
