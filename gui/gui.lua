...
local iconsList = {
    C.Assets.Textures.IconGeneral,
    C.Assets.Textures.IconNotification,
    C.Assets.Textures.IconInfobar,
    C.Assets.Textures.IconChat,
    C.Assets.Textures.IconActionbar,
    C.Assets.Textures.IconCombat,
    C.Assets.Textures.IconAnnouncement,
    C.Assets.Textures.IconBackpack,
    C.Assets.Textures.IconMap,
    C.Assets.Textures.IconTooltip,
    C.Assets.Textures.IconUnitframe,
    C.Assets.Textures.IconGroupframe,
    C.Assets.Textures.IconNameplate,
    C.Assets.Textures.IconTheme,
    C.Assets.Textures.IconProfile,
    C.Assets.Textures.IconAbout,
    C.Assets.Textures.IconCredits,
}
...
local function CreateGameMenuButton()
    ...
    if _G.GameMenuButtonAddons then
        ...
        bu:SetPoint('TOP', _G.GameMenuFrame, 'TOP', 0, -60)
    end
